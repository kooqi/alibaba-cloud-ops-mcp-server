...
def test_run_as_main(monkeypatch):
    ...
    with patch('alibaba_cloud_ops_mcp_server.tools.oss_tools.tools', [mock_tool1]), \
         patch('alibaba_cloud_ops_mcp_server.tools.oos_tools.tools', [mock_tool2]), \
         patch('alibaba_cloud_ops_mcp_server.tools.cms_tools.tools', [mock_tool3]), \
         patch('alibaba_cloud_ops_mcp_server.tools.common_api_tools.tools', [mock_tool4, mock_tool5, mock_tool6, mock_tool7]), \
         patch('alibaba_cloud_ops_mcp_server.tools.api_tools.create_api_tools'):
